    ...
    it('parses timeline correctly', () => {
      ...
      expect(feed.timeline[1]).toEqual({
        ...
        media: [
          {
            thumbnail:
              'https://scontent-arn2-1.cdninstagram.com/v/t51.2885-15/sh0.08/e35/c0.180.1440.1440a/s640x640/120098853_333506938099587_49080806762893934_n.jpg?_nc_ht=scontent-arn2-1.cdninstagram.com&_nc_cat=103&_nc_ohc=Qg5ddUTOiVQAX_7Ue3T&oh=292b9a1606e58710f304e461c7abca22&oe=5F9F08D3',
          },
        ],
      })
    })
